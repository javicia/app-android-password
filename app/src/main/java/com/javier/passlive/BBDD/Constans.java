...
public class Constans {
    ...
    public static final String B_TITLE_ACCOUNT_BANK ="TITULAR_CUENTA";
    ...
    public static final String B_ID_CATEGORY = "ID_CATEGORIA";
