...
class Passphrase(sharedPreferences: SharedPreferences) {
    class Passphrase constructor(
        ...
        fun getPassphrase(): ByteArray {
            ...
            this.passphrase?.let {
                ...
                return if (this@Passphrase.sharedPreferences.contains(DB_KEY) && this@Passphrase.sharedPreferences.contains(IV_KEY)) {
                    val encryptedData = this@Passphrase.sharedPreferences.getString(DB_KEY, null)
                    val iv =
                        Base64.decode(this@Passphrase.sharedPreferences.getString(IV_KEY, null), Base64.DEFAULT)
                    ...
                    this@Passphrase.sharedPreferences.edit().putString(DB_KEY, encryptedData.toString(CHARSET))
                        .apply()
        ...
        private fun encrypt(byteArray: ByteArray): ByteArray {
            ...
            sharedPreferences.edit()
                .putString(IV_KEY, Base64.encodeToString(cipher.iv, Base64.DEFAULT)).apply()
